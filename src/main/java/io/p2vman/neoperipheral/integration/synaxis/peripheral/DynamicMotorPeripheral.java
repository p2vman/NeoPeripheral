...
public class DynamicMotorPeripheral implements IPeripheral {
    ...
    public final void setGainP(double p) {
        entity.setGainP(p);
    }

    @LuaFunction(mainThread = true)
    public final void setGainI(double i) {
        entity.setGainI(i);
    }

    @LuaFunction(mainThread = true)
    public final void setGainD(double d) {
        entity.setGainD(d);
    }
    ...
    @LuaFunction(mainThread = true)
    public final double getGainP() {
        return entity.gainP();
    }

    @LuaFunction(mainThread = true)
    public final double getGainI() {
        return entity.gainI();
    }

    @LuaFunction(mainThread = true)
    public final double getGainD() {
        return entity.gainD();
    }
    ...
    @LuaFunction(mainThread = true)
    public final void setGravityCompensation(boolean enable) {
        entity.setEliminateGravity(enable);
    }

    @LuaFunction(mainThread = true)
    public final boolean getGravityCompensation() {
